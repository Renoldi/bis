...
use App\Models\FleetType as ModelsFleetType;
use CodeIgniter\API\ResponseTrait;
use CodeIgniter\RESTful\ResourceController;

class FleetType extends ResourceController
{
    protected $modelName = ModelsFleetType::class;
     ...
     *     @OA\JsonContent(
     *      type="array",
     *       @OA\Items(ref="#/components/schemas/FleetType")
     *     ),
     *   ),
     *   @OA\Response(
     ...
     *   @OA\Response(
     *     response=200, description="ok",
     *      @OA\JsonContent(ref="#/components/schemas/FleetType")
     *   ), 
     *   @OA\Response(
     *     response=400, description="Bad Request"
     *   ),
     ...
     *      @OA\Schema(ref="#/components/schemas/FleetType"),
     *     )
     *   ),
     *   @OA\Response(
