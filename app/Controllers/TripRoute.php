...
use App\Models\TripRoute as ModelsTripRoute;
use CodeIgniter\API\ResponseTrait;
use CodeIgniter\RESTful\ResourceController;

class TripRoute extends ResourceController
{
    protected $modelName = ModelsTripRoute::class;
