...
use App\Entities\PriPrice as EntitiesPriPrice;
use App\Libraries\StdobjeToArray;
use App\Models\PriPrice as ModelsPriPrice;
use CodeIgniter\API\ResponseTrait;
use CodeIgniter\RESTful\ResourceController;

class PriPrice extends ResourceController
{
    protected $modelName = ModelsPriPrice::class;
     ...
     *     @OA\JsonContent(
     *      type="array",
     *       @OA\Items(ref="#/components/schemas/PriPrice")
     *     ),
     *   ),
     *   @OA\Response(
     ...
     *   @OA\Response(
     *     response=200, description="ok",
     *      @OA\JsonContent(ref="#/components/schemas/PriPrice")
     *   ), 
     *   @OA\Response(
     *     response=400, description="Bad Request"
     *   ),
     ...
     *      @OA\Schema(ref="#/components/schemas/PriPrice"),
     *     )
     *   ),
     *   @OA\Response(
