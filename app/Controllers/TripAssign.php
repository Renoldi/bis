...
use App\Entities\TripAssign as EntitiesTripAssign;
use App\Libraries\StdobjeToArray;
use App\Models\TripAssign as ModelsTripAssign;
use CodeIgniter\API\ResponseTrait;
use CodeIgniter\RESTful\ResourceController;

class TripAssign extends ResourceController
{
    protected $modelName = ModelsTripAssign::class;
     ...
     *     @OA\JsonContent(
     *      type="array",
     *       @OA\Items(ref="#/components/schemas/TripAssign")
     *     ),
     *   ),
     *   @OA\Response(
     ...
     *   @OA\Response(
     *     response=200, description="ok",
     *      @OA\JsonContent(ref="#/components/schemas/TripAssign")
     *   ), 
     *   @OA\Response(
     *     response=400, description="Bad Request"
     *   ),
     ...
     *      @OA\Schema(ref="#/components/schemas/TripAssign"),
     *     )
     *   ),
     *   @OA\Response(
